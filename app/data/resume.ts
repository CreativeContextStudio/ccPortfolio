...
export interface ResumeData {
  ...
  pdfUrl?: string;
  agentInfo?: { name: string; operationalStatus: string };
}

export const resumeData: ResumeData = {
  agentInfo: { name: 'JAMES McKAY', operationalStatus: 'REMOTE-FIRST / GLOBAL OPERATIONS' },
  workHistory: [
    {
  ...
  certifications: [
    {
      title: '20 YEARS TRADITIONAL, BRAND, & BROADCAST EXPERIENCE',
      period: '2005-PRESENT',
  ...
  pdfUrl: '/McKayResumeComplete2025.pdf',
};
